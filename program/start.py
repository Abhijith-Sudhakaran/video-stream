        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
                    ...
                    InlineKeyboardButton(
                        "💬 Group", url="https://t.me/AAMIBOTSUPPORT"),
                    InlineKeyboardButton(
                        "📣 Channel", url="https://t.me/AAMIBOTUPDATES")
                ], [
                    InlineKeyboardButton(
                        "👩🏻‍💻 Developer", url="https://t.me/Telecat_X")
                ], [
                    InlineKeyboardButton(
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "✨ Group", url=f"https://t.me/AAMIBOTSUPPORT"
                    ),
                    InlineKeyboardButton(
                        "📣 Channel", url=f"https://t.me/AAMIBOTUPDATES"
                    )
                ]
            ]
        )
